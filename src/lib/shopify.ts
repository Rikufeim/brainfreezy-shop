...
const SHOPIFY_STORE_PERMANENT_DOMAIN = 'brainfreezy-shop-su1xu.myshopify.com';
const SHOPIFY_STOREFRONT_URL = `https://${SHOPIFY_STORE_PERMANENT_DOMAIN}/api/${SHOPIFY_API_VERSION}/graphql.json`;
const SHOPIFY_STOREFRONT_TOKEN = '7db8e45c856c72c312c11cdde30fc579';
...
export async function syncCartWithShopify(cartId: string): Promise<boolean> {
