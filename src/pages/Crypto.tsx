...
const cryptoProducts: Array<{
  ...
  { id: "CR-01", name: "Crypto Starter Pack", price: "$29", category: "Crypto" },
  { id: "CR-02", name: "Market Signals Guide", price: "$49", category: "Crypto" },
  { id: "MS-01", name: "Decision Clarity Kit", price: "$39", category: "Mindset" },
  { id: "VC-01", name: "Prompt Flow Pack", price: "$29", category: "Vibe coding" },
  { id: "SA-01", name: "Pipeline Execution Notes", price: "$35", category: "Sales" },
  { id: "CR-03", name: "Macro Playbook", price: "$79", category: "Crypto" },
  { id: "MS-02", name: "Risk Psychology Guide", price: "$25", category: "Mindset" },
  { id: "VC-02", name: "Landing Page Library", price: "$59", category: "Vibe coding" },
];

export default function Crypto() {
  const [selectedCategory, setSelectedCategory] = useState<Category>("All");
  const filteredProducts = cryptoProducts.filter(
      ...
      <main className="pt-24">
        <section className="py-16 px-6 md:px-12 bg-transparent w-full relative z-10">
          <div className="max-w-7xl mx-auto mb-10">
            <h1 className="text-3xl md:text-5xl font-black text-white text-left mb-4">
              Crypto templates & guides
            </h1>
            <p className="text-white/70 text-base md:text-lg max-w-4xl text-left">
              Build your personal crypto knowledge and decision system in Notion. Capture market insights, organize information, and connect signals to improve your thinking and judgment. These templates and guides help you create a digital extension of your crypto process that grows more valuable over time.
            </p>
          </div>
            ...
            <div className="flex flex-wrap gap-4">
              {categories.map((category) => (
                <button
                  ...
                  className={`px-4 py-2 rounded-full text-xs md:text-sm font-display font-bold tracking-widest uppercase border transition-colors
                    ${
