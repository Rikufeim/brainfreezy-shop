    ...
    >
      ...
      <footer className="relative py-8 px-6 md:px-12 bg-black w-full z-10 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <StarfieldBackground transparentBg minimal />
        </div>
        <div className="max-w-7xl mx-auto relative z-[1] w-full">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex-1" />
            <div className="flex justify-center items-center gap-6 md:gap-12 order-first md:order-none">
            ...
            <div className="flex items-center justify-end gap-4 flex-1">
              ...
              <img src={icyMascot} alt="ICY" className="w-16 h-16 md:w-20 md:h-20 object-contain" />
            </div>
          </div>
        </div>
      </footer>
